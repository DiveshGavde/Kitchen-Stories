  ...
  return (
    <>
      ...
      <dialog ref={dialog} className={`${classes.addrecipe_window}`}>
        ...
        <form method="dialog" className={classes.upload}>
          <div className={classes.upload_column}>
            <h3 className={classes.recipe_data}>Recipe Data</h3>
            <label>Title</label>
            <input placeholder="TEST23" type="text" required />
            <label>url</label>
            <input placeholder="TEST23" type="text" required />
          ...
          <div className={classes.upload_column}>
            ...
            <input placeholder="35" type="number" required />
            <label>Ingredient6</label>
            <input placeholder="4" type="number" required />
          </div>
